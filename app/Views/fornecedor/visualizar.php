...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Visualizar fornecedor</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <form action="" method="POST">
                            <div class="card-body">                               
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input type="text" class="form-control" disabled name="nome" value="<?php echo $fornecedor['nome']; ?>" name="nome" placeholder="Digite a nome da conta do Dre" required>
                                </div>                               
                            </div>                           
                        </form>
                    </div>
