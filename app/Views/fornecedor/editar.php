            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?php base_url() ?>/fornecedor/atualizar" method="POST">
                            <div class="card-body">
                                <input type="hidden" class="form-control" id="id_fornecedor" name="id_fornecedor" value="<?php echo $fornecedor['id_fornecedor'] ?>">
