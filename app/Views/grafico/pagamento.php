                                            ...
                                            <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                                <div class="card-body table-responsive p-0">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <div id="PagamentoPieChart" style="width: 800px; height: 400px"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div>
                                                            <div id="PagamentoPieChart2" style="width: 600px; height: 350px"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
$dataPagamento = [['Nome', 'Total']];
foreach ($valoresPagamento as $value) {
    $dataPagamento[] = [$value['nome'], floatval($value['total'])];
}
$dados_json = json_encode($dataPagamento);
?>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('PagamentoPieChart'));
...
<script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var chart = new google.charts.Bar(document.getElementById('PagamentoPieChart2'));
