            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        ...
                        <form action="<?php base_url() ?>/cliente/atualizar" method="POST">
                            <div class="card-body">
                                <input type="hidden" class="form-control" id="id_cliente" name="id_cliente" value="<?php echo $cliente['id_cliente'] ?>">
