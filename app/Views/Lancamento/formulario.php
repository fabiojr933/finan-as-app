            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <a class="btn btn-primary btn-group" style="margin-right: 15px;" href="/lancamento"><i class="fas fa-share"></i></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="pagamento" name="id_pagamento" style="width: 100%;"  required>
                                            <?php foreach($pagamento as $pag) { ?>   
                                            <option value="<?php echo $pag['id_pagamento'] ?>"><?php echo $pag['nome'] ?></option>                                           
                                            <?php } ?>   
                                            </select>
                                        </div>
                                    </div>                                  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" id="id_despesa" name="id_despesa" style="width: 100%;" required>
                                                <?php foreach ($despesa as $data) {  ?>
                                                    <option value="<?php echo $data['id_conta_fluxo'] ?>"><?php echo $data['nome'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
