                                                ...
                                                <div class="card-body table-responsive p-0">
                                                    <table id="tabelaDados" class="table table-hover text-nowrap table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php if (!empty($lancamento)) : ?>
                                                                <?php foreach ($lancamento as $data) : ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $data['tipo'] == 'receita' ? '<span class="badge bg-primary">Receita</span>' : '<span class="badge bg-danger">Despesa</span>' ?></td>
                                                            ...
                                                            <?php else : ?>
                                                                <tr>
                                                                    <td colspan="6">Nenhum lançamento cadastrada</td>
                                                                </tr>
                                                            <?php endif; ?>
                                                        </tbody>
                                                    </table>
