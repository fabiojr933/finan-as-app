...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Visualizar conta a pagar</h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group" id="valor">
                                        ...
                                        <input type="text" class="form-control" id="valor" name="valor" value="<?php echo $contasPagar['valor'] ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" name="id_fornecedor" style="width: 100%;" disabled>
                                            <option value="<?php echo $contasPagar['id_fornecedor'] ?>"><?php echo $contasPagar['nome'] ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
